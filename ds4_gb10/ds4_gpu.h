...
ds4_gpu_tensor *ds4_gpu_tensor_alloc_mapped_host(uint64_t bytes);
...
int ds4_gpu_routed_moe_one_external_tensor(
        ds4_gpu_tensor       *out,
        ds4_gpu_tensor       *gate,
        ds4_gpu_tensor       *up,
        ds4_gpu_tensor       *mid,
        ds4_gpu_tensor       *experts,
        const ds4_gpu_tensor *gate_w,
        const ds4_gpu_tensor *up_w,
        const ds4_gpu_tensor *down_w,
        uint32_t                gate_type,
        uint32_t                down_type,
        uint64_t                gate_expert_bytes,
        uint64_t                gate_row_bytes,
...
int ds4_gpu_routed_moe_one_external_slots_tensor(
        ds4_gpu_tensor       *out,
        ds4_gpu_tensor       *gate,
        ds4_gpu_tensor       *up,
        ds4_gpu_tensor       *mid,
        ds4_gpu_tensor       *down,
        const ds4_gpu_tensor *gate_slots,
        const ds4_gpu_tensor *up_slots,
        const ds4_gpu_tensor *down_slots,
        uint32_t                gate_type,
        uint32_t                down_type,
        uint64_t                gate_expert_bytes,
        uint64_t                gate_row_bytes,
        ...
        uint32_t                expert_mid_dim,
        uint32_t                out_dim,
        const ds4_gpu_tensor *selected_slots,
        const ds4_gpu_tensor *weights,
        uint32_t                n_expert,
        float                   clamp,
        const ds4_gpu_tensor *x);

int ds4_gpu_routed_moe_one_external_blob_slots_tensor(
        ds4_gpu_tensor       *out,
        ds4_gpu_tensor       *gate,
        ds4_gpu_tensor       *up,
        ds4_gpu_tensor       *mid,
        ds4_gpu_tensor       *down,
        const ds4_gpu_tensor *blob_slots,
        uint32_t                gate_type,
        uint32_t                down_type,
...
int ds4_gpu_routed_moe_batch_external_tensor(
        ds4_gpu_tensor       *out,
        ds4_gpu_tensor       *gate,
        ds4_gpu_tensor       *up,
        ds4_gpu_tensor       *mid,
